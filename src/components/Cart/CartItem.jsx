            ...
            <div className="w-full flex float-left border-b-2 border-gray-300">
                <div className="w-1/12 flex justify-center">
                    <input type="checkbox" checked={props.checked}
                           onChange={() => props.onChange(props.cartItemID)}/>
                </div>
            ...
            <span className="flex pr-4 pl-4 pt-2 font-bold">
              {props.productName}
                    ...
                    <div className="w-full flex text-sm pl-2">
                        <select
                            className="flex pr-6 pl-6 pt-2 pb-2 mt-2 bg-gray-200 rounded-sm outline-none cursor-pointer">
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
                ...
                <div className="w-2/12">
                    <div className="w-full flex justify-end">
                        <span className="flex pr-4 pl-4 pt-2 font-bold">₹ {props.cartItemPrice}</span>
                    </div>
                    <div className="w-full flex justify-end">
